...
export default function AdminDashboard() {
  ...
  const helpRequests = [
    {
      id: "HIM-2024-001",
      name: language === "ur" ? "احمد علی" : "Ahmad Ali",
      type: "rozgar",
    ...
    {
      id: "HIM-2024-004",
      name: language === "ur" ? "عائشہ بیگم" : "Ayesha Begum",
      type: "medical",
      program: "Medical Aid",
      status: "pending",
      date: "2024-01-12",
  ...
  const loanRequests = [
    {
      ...
      city: "Multan",
      guarantor: language === "ur" ? "محمد علی" : "Muhammad Ali",
    },
    {
      id: "LOAN-2024-002",
      ...
      city: "Peshawar",
      guarantor: language === "ur" ? "احمد خان" : "Ahmad Khan",
    },
    {
      id: "LOAN-2024-003",
      name: language === "ur" ? "حسن علی" : "Hassan Ali",
      type: "agriculture",
      amount: "75000",
      status: "under_review",
      date: "2024-01-13",
      ...
      city: "Sialkot",
      guarantor: language === "ur" ? "علی حسن" : "Ali Hassan",
    },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent flex items-center">
                <Shield className="h-10 w-10 mr-3 text-emerald-600" />
                {t("vips")} {t("adminPanel")}
              </h1>
              <p className="text-slate-600 mt-2">{t("manageAllApplicationsRequests")}</p>
            </div>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span className="flex items-center">
                    ...
                    {t("loanApplicationsManagement")} ({loanRequests.length})
                  </span>
                  <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-slate-600">ID: {loan.id}</p>
                              </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              <div className="flex items-center text-slate-600">
                                <DollarSign className="h-4 w-4 mr-2" />
                                PKR {Number.parseInt(loan.amount).toLocaleString()}
                              </div>
                              <div className="flex items-center text-slate-600">
                                <MapPin className="h-4 w-4 mr-2" />
                                {loan.city}
